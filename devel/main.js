var pocket = ["Bulbasaur","Ivysaur","Venusaur","Charmander","Charmeleon",
...
"Staravia","Staraptor","Bidoof","Bibarel","Kricketot","Kricketune","Shinx",
...
"Drifloon","Drifblim","Buneary","Lopunny","Mismagius","Honchkrow","Glameow",
...
"Scolipede","Cottonee","Whimsicott","Petilil","Lilligant","Basculin","Sandile",
"Krokorok","Krookodile","Darumaka","Darmanitan","Maractus","Dwebble","Crustle",
"Scraggy","Scrafty","Sigilyph","Yamask","Cofagrigus","Tirtouga","Carracosta",
...
"Litleo","Pyroar","Flabebe","Floette","Florges","Skiddo","Gogoat","Pancham",
...
function img1(){
              ...
              pokeNum = Math.floor( Math.random() * 721 );
            var pokeName = pocket[pokeNum];
            var Num = pokeNum;
            var imageNum = Num + 1;

    document.getElementById("Img").src = "official-artwork\\" + imageNum + ".png";
    document.getElementById("pokem").innerHTML = pokeName;
          }
          ...
          function img2(){
              ...
              document.getElementById("Img2").src = "official-artwork\\" + imageNum + ".png";
              document.getElementById("pokem2").innerHTML = pokeName;
                    }
              function img3(){
                        ...
                        document.getElementById("Img3").src = "official-artwork\\" + imageNum + ".png";
                        document.getElementById("pokem3").innerHTML = pokeName;
                              }
                      function img4(){
                          ...
                          document.getElementById("Img4").src = "official-artwork\\" + imageNum + ".png";
                          document.getElementById("pokem4").innerHTML = pokeName;
                                        }
                                        function img5(){
                                            ...
                                            document.getElementById("Img5").src = "official-artwork\\" + imageNum + ".png";
                                            document.getElementById("pokem5").innerHTML = pokeName;
                                                  }
                                                  function img6(){
                                                      ...
                                                      document.getElementById("Img6").src = "official-artwork\\" + imageNum + ".png";
                                                      document.getElementById("pokem6").innerHTML = pokeName;
                                                            }
